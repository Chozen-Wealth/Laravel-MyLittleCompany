...
@section("content")
    ...
    <form style="position: absolute; z-index: 1; left: 50%; top: 50%; transform: translate(-50%,-50%); background-color: rgba(255, 255, 255, 0.9);" class="form-control w-25 d-flex flex-column gap-2 p-5" action="" method="post">
