...
@section("content")
    ...
    <section>
        <h1 class="text-center mt-5 bg-dark text-white shadow-sm p-4 rounded">Nos services</h1>
        <div class="d-flex flex-column gap-5">
            <div class="d-flex align-items-center bg-white p-5 gap-5 shadow-sm rounded-3">
                <div class="w-50">
                ...
                <img class="w-50 rounded-5" src="https://newsfeed.time.com/wp-content/uploads/sites/9/2011/11/dundermifflin.jpg?w=600" alt="">
            </div>
            <div class="d-flex align-items-center bg-white p-5 gap-5 shadow-sm rounded-3">
                <div class="w-50">
                ...
                <img class="w-50 rounded-5" src="https://www.nbc.com/sites/nbcblog/files/styles/scale_862/public/2023/08/the-office-character-recap-oscar-nunez.jpg" alt="">
            </div>
            <div class="d-flex align-items-center bg-white p-5 gap-5 shadow-sm rounded-3">
                <div class="w-50">
                ...
                <img class="w-50 rounded-5" src="https://i.ytimg.com/vi/iD4MAy8jAWc/maxresdefault.jpg" alt="">
            </div>
        </div>
    </section>
    <section>
