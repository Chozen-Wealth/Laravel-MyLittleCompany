...
@section("content")
    ...
    <section>
        <h1 class="text-center mt-5 bg-dark text-white shadow p-4 rounded">Nos services</h1>
        <div class="d-flex flex-column gap-5">
            <div class="d-flex align-items-center bg-light p-5 gap-5 shadow rounded-3">
                <div class="w-50">
